    ...
    <div class='container'>
        ...
        <div class="card">
          ...
          <form>
            <div className='p-5'>
            <br></br>
            <input id="user-email" class="inpbox" type="username" placeholder='Username' autocomplete="on" required />
            </div>
            <div className='mb-2'>
            <br></br>
            <input id="password" class="inpbox" type="password" placeholder='Password'  required />
            </div>

            <p><Link to='/alogin'><input class="sub-btn" type="submit" name="submit" value="LOGIN" /></Link></p>
